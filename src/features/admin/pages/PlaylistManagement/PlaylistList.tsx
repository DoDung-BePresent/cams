...
export const PlaylistList = () => {
  ...
  const handleFilterChange = (
    key: keyof PlaylistFilter,
    value: PlaylistFilter[keyof PlaylistFilter],
  ) => {
  ...
  const columns = getPlaylistColumns({
    ...
    // Only show CRUD actions for shared playlists (brandId === null)
