...
import type {
  ...
  PairingMethod,
  QRCodePayload,
} from '@/features/brand/types/deviceTypes';
import { pairDeviceValidation } from '@/features/brand/validations/deviceValidation';
import { useBranchStore } from '@/features/brand/stores/useBranchStore';
import {
  PAIRING_CODE_EXPIRY_MINUTES,
  QR_CODE_EXPIRY_MINUTES,
} from '@/features/brand/constants/deviceConstants';
