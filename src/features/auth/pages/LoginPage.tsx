  ...
  return (
    <>
      ...
      <AuthWrapper>
        ...
        >
          {/* A soft gradient orb behind the form to prove the glass refraction is working */}
          <div className='pointer-events-none absolute top-1/2 left-1/2 h-[500px] w-[500px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-gradient-to-tr from-blue-200 via-indigo-100 to-purple-200 opacity-60 mix-blend-multiply blur-[80px]' />
