...
export const STORE_OVERRIDE_INTENT_OPTIONS: SelectProps['options'] = [
  { label: 'No override intent', value: StoreOverrideIntentEnum.None },
  {
    label: 'Allow space override',
    value: StoreOverrideIntentEnum.AllowSpaceOverride,
  },
  {
    label: 'Force inherit to child spaces',
    value: StoreOverrideIntentEnum.ForceInheritToAllSpaces,
  },
];
